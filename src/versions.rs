...
const KNOWN_VERSIONS: &[KnownVersion] = &[
    ...
    KnownVersion {
        ...
        cpu: CPUArch::AArch64,
        version: "31.1",
        hash: hex!("6c554de11cea04c56ebf8e45b54434019b1cd85223d4bbd25c282425e306ecc2"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::X86_64,
        version: "31.1",
        hash: hex!("96553041f1a91ea0efee963cb16f462f5985b4d65365f3907414c360044d8065"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::AArch64,
        version: "31.1",
        hash: hex!("4aeea0a34b0992847b03a8489a8dbedf3746de01109b74cc2ce9b6888a901ed9"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::X86_64,
        version: "31.1",
        hash: hex!("485e87088b18614c25a99b1c0627918b3ff5b9fde54922fb1c920159fab7ba29"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::AArch64,
        version: "33.0",
        hash: hex!("4b96bc91f8b54d829b8c3ca2207ff1ceb774843321e4fa5a68502faece584272"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::X86_64,
        version: "33.0",
        hash: hex!("d99c011b799e9e412064244f0be417e5d76c9b6ace13a2ac735330fa7d57ad8f"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::AArch64,
        version: "33.0",
        hash: hex!("3cf55dd47118bd2efda9cd26b74f8bbbfcf5beb1bf606bc56ad4c001b543f6d3"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::X86_64,
        version: "33.0",
        hash: hex!("e4e50a703147a92d1a5a2d3a34c9e41717f67ade67d4be72b9a466eb8f22fe87"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::AArch64,
        version: "33.2",
        hash: hex!("706662a332683aa2fffe1c4ea61588279d31679cd42d91c7d60a69651768edb8"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::X86_64,
        version: "33.2",
        hash: hex!("b24b53f87c151bfd48b112fe4c3a6e6574e5198874f38036aff41df3456b8caf"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::AArch64,
        version: "33.2",
        hash: hex!("5be1427127788c9f7dd7d606c3e69843dd3587327dea993917ffcb77e7234b44"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::X86_64,
        version: "33.2",
        hash: hex!("dba51cfcc85076d56e7de01a647865c5a7f995c3dce427d5215b53e50b7be43f"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::AArch64,
        version: "33.5",
        hash: hex!("2b0fcf9b2c32cbadccc0eb7a88b841fffecd4a06fc80acdba2b5be45e815c38a"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::X86_64,
        version: "33.5",
        hash: hex!("24e58fb231d50306ee28491f33a170301e99540f7e29ca461e0e80fd1239f8d1"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::AArch64,
        version: "33.5",
        hash: hex!("7084c6482e3bb416a33fe2162ba566711773b842e6953bf6cb181647b9ef57c0"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::X86_64,
        version: "33.5",
        hash: hex!("7f31625f8bec4929082ae9209e101c1c03692624457cc6332f83736db495ee92"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::AArch64,
        version: "34.0",
        hash: hex!("f0b8aad28be5ea6150c082f96ac57e028154afb9ee29f4ce092b5a39df8ae6c8"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::X86_64,
        version: "34.0",
        hash: hex!("e9a91b6fcfe4177ec2cd35fc8f15c1e811fa0ecdef9372755cd6d3513d5faaab"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::AArch64,
        version: "34.0",
        hash: hex!("3ef35187a3c8aed81ee57e792227e483e558fa56c93fce525e569bff55794c1a"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::X86_64,
        version: "34.0",
        hash: hex!("d58fcd413a9ed458283d54023e409fd5cf767da4ed225d1ffaffd83cf2764f53"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::AArch64,
        version: "34.1",
        hash: hex!("31c5e9e3c7bf013cf41fb97765ee255c140024a6b175b6cc9b64beddd7c23ba7"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::X86_64,
        version: "34.1",
        hash: hex!("af27ea66cd26938fe48587804ca7d4817457a08350021a1c6e23a27ccc8c6904"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::AArch64,
        version: "34.1",
        hash: hex!("2c7e92b8b578916937df132b3032e2e8e6c170862ecf7a8333094a6f3d03650c"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::X86_64,
    ...
    KnownVersion {
        ...
        cpu: CPUArch::AArch64,
        version: "35.1",
        hash: hex!("01bf9d08808c7f96678b63f4bd8efa559bb4f83d5a7a270d5edaf507f9d5d9cf"),
    },
    KnownVersion {
        os: OS::Linux,
        cpu: CPUArch::X86_64,
        version: "35.1",
        hash: hex!("6930ebf62bd4ea607b98fff052596c6ee564b9835b4ce172c75a3f53ae9d91b7"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::AArch64,
        version: "35.1",
        hash: hex!("193289af0470c6a1aada357d4fba0bbf8d78bfaac8b5e42ca30af2ef75583de2"),
    },
    KnownVersion {
        os: OS::OSX,
        cpu: CPUArch::X86_64,
        version: "35.1",
        hash: hex!("537d73604a344ded6fc94e98e07e529d4fe3e4a0b09e59905353950fafc2a1f7"),
    },
];
